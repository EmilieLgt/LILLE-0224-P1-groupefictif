...
function filterPays() {
	...
	filtre = document
		.getElementById("rechercheTourneePays")
		.value.toUpperCase();
...
function filterCity() {
	...
	filtre = document
		.getElementById("rechercheTourneeVille")
		.value.toUpperCase();
	tableau = document.getElementById("tableTournee");
	ligne = tableau.getElementsByTagName("tr");
...
const titleFantine = document.getElementById("so-cool");
console.log(titleFantine);
titleFantine.addEventListener("click", function () {
	alert(
		"Fantine is the very best and we are very lucky to have her, we should treat her like she deserves."
	);
});
